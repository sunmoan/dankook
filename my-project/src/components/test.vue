<template>
    <section>
        ...
        <h2 style="font-size:0.9em;color:red;margin-top:0px">*해외 전화번호로는 인증하시더라도 이용이 불가능합니다.</h2>
        <h2 style="font-size:0.9em;color:red;margin-top:0px">*소셜 로그인(Facebook)을 사용하시면 간편하게 이용이 가능합니다.</h2>
